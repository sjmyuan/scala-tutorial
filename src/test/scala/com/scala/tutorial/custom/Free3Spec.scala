...
import com.scala.tutorial.custom.category.monad.Free3
...
/**
  ...
  */
class Free3Spec extends FunSpec with Matchers {
  ...
  describe("Free") {
    describe("run") {
      it("should return the correct result") {
        ...
        val expressions = for {
          x1 <- Free3.lift[Request,String](GetName())
          x2 <- Free3.lift[Request,String](GetInfoByName(x1))
          x3 <- Free3.lift[Request,String](GetAddressByInfo(x2))
        } yield x3
